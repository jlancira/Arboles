...
#con el trim false, esta haciendo estimaciones, no es solo los datos originales
```
```{r}
...
ggplot(mpg, aes(x = hwy)) + geom_histogram(aes(y=..density..), color = "grey30", fill = "blue") +geom_density(alpha = .2, fill = "antiquewhite3") + labs(title="Bin width 1")
```
```{r}
